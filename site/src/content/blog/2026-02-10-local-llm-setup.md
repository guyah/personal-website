...
It’s a **memory question**, then a **throughput question**, then an **ops question**.

This post is my high-signal checklist for getting to a local setup that’s:
...
## Step 1 — VRAM math you can do on a napkin
...
### KV cache scales linearly (and doesn’t care about your optimism)
...
- “I just want 32k context” is a memory commitment.
- “I want 16 concurrent chats” multiplies the KV cache budget.

For many local setups, the constraint isn’t FLOPs—it’s: *can you keep enough KV in VRAM without paging?*

## Step 2 — picking a GPU (for local inference)
...
### Don’t ignore the boring constraints
...
## Step 3 — precision and quantization: what you’re trading
...
You’re not buying “4-bit”. You’re buying:
...
## Step 4 — runtimes: GGUF vs vLLM vs TGI
...
- you’re okay with a more “server” mindset
...
## Step 5 — throughput vs latency: you’re on a frontier
...
- interactive mode: cap batching time (e.g. 10–30ms)
- batch mode: maximize utilization, accept latency
- mixed mode: separate queues / replicas

## Step 6 — LoRA fine-tuning basics (just enough)
...
- evaluation is often missing (people “feel” improvements)
...
4. test under the *serving runtime* you’ll actually deploy
...
- Add a worked example: “Given 24GB VRAM, what model + context + concurrency fits?”
