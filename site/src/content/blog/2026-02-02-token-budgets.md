...
This should not be used for billing or precision. It’s a *back-of-the-envelope planner*.
...
- long “help” pages retrieved by RAG
...
- Add a real-tokenizer comparison (e.g. tiktoken) once that’s available in this environment.
